    ...
    return (
        ...
        <div className="row m-4">
            ...
            <div className="card " >
                ...
                <h1>{content.title}</h1>
                <div>
                    <button className="btn btn-danger me-4" onClick={deleteFun}>Sil</button>
                    <button className="btn btn-success" onClick={updateFun}>Düzenle</button>
                </div>
                </div>
                                ...
                                <div className="col-12" style={{borderTop:".4 solid #333"}}>
                                    {
                                     comments &&  comments.map(com => (
                                            ...
                                            <div className="col-2 d-flex justify-content-center align-items-center">
                                              <button key={"removeCommentButton"+com.id} className="btn btn-danger" style={{fontSize:"12px"}} onClick={(e)=> {removeComment(e,com.id)}}><FontAwesomeIcon icon={faTrash} />Sil</button>
                                            </div>
                                        </div>
